...
const VILLAGES_AND_CITIES: SettlementPoint[] = [
  ...
  {
    id: 'city-pokhara',
    name: 'Pokhara Municipal City',
    type: 'city',
    lat: 28.2096,
    lng: 83.9856,
    population: '518,000+',
    district: 'Kaski District HQ',
    elevation_m: 820,
  },
  {
    id: 'town-barhabise',
    name: 'Barhabise Arniko Highway Town',
    type: 'town',
    lat: 27.8600,
    lng: 85.8700,
    population: '22,000+',
    district: 'Bhotekoshi Corridor',
    elevation_m: 820,
  },
  {
    id: 'village-tatopani',
    name: 'Tatopani Trans-Himalayan Gate',
    type: 'village',
    lat: 27.9100,
    lng: 85.9000,
    population: '5,400',
    district: 'Nepal-China Border Sector',
    elevation_m: 1450,
  },
  {
    id: 'village-sundarijal',
    name: 'Sundarijal Shivapuri Ridge',
    type: 'village',
    lat: 27.8000,
    lng: 85.4200,
    population: '11,200',
    district: 'Kathmandu North Intake',
    elevation_m: 1420,
  },
  {
    id: 'town-balkhu',
    name: 'Balkhu City Riverside Market',
    type: 'town',
    lat: 27.6800,
    lng: 85.3100,
    population: '85,000+',
    district: 'Bagmati Corridor Core',
    elevation_m: 1290,
  },
  {
    id: 'village-chobar',
    name: 'Chobar Gorge Exit Post',
    type: 'village',
    lat: 27.6500,
    lng: 85.2900,
    population: '8,900',
    district: 'Kathmandu Outlet Sector',
    elevation_m: 1250,
  },
  {
    id: 'town-trisuli',
    name: 'Trisuli Highway Sector',
    type: 'town',
    lat: 27.8000,
    lng: 84.8200,
    population: '34,000+',
    district: 'Prithvi Highway Lifeline',
    elevation_m: 340,
  },
  {
    id: 'town-devghat',
    ...
    lng: 84.4200,
    population: '29,000+',
    district: 'Chitwan Floodplain Entrance',
    elevation_m: 180,
  },
  {
    id: 'city-chatara',
    name: 'Chatara Koshi Barrage Sector',
    type: 'city',
    lat: 26.8700,
    lng: 87.1500,
    population: '120,000+',
    district: 'Sunsari Saptakoshi Hub',
    elevation_m: 140,
  },
  {
    id: 'city-chisapani',
    name: 'Chisapani Karnali Bridge City',
    type: 'city',
    lat: 28.6400,
    lng: 81.2800,
    population: '65,000+',
    district: 'Kailali Karnali Delta',
    elevation_m: 190,
  },
  {
    id: 'town-dodhara',
    name: 'Dodhara-Chandani Mahakali Town',
    type: 'town',
    lat: 28.9100,
    lng: 80.0800,
    population: '48,000+',
    district: 'Kanchanpur Border Sector',
    elevation_m: 175,
  },
];
